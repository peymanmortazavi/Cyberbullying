  ...
  render: function() {
    return (
      <div className="about">
          ...
          <p>
              <i>Definition of a victim</i>: The individual that is the target of aggression/insult/harassment. Definition of a perpetrator: The individual who posts aggressive/insulting/harassing/ unwanted questions/comments.
          </p>
          <p>
              <i>Definition of defenders</i>: Individuals with posts that dislike the cyberbullying and defend the victim from the perpetrators of aggression/insults/harassment. The goal of the defender is to help the victim who is being cyberbullied, even with usage of offensive words by attacking the perpetrators.
          </p>
          <p>
              <i>Definition of a follower</i>: Individuals that take an active part in cyberaggression or cyberbullying but do not start the cyberaggression or cyberbullying.
          </p>
          ...
          <ol type="I">
              ...
              <li>
                  Answer the questions about the image and its posts, using the best of your ability
              </li>
          </ol>
      </div>
    );
